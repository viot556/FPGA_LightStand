...
HD_PWD='D:/FPGA/FSM_LightStand/FSM_LightStand.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Light.tcl -notrace
