...
HD_PWD='D:/FPGA/FSM_LightStand/FSM_LightStand.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Light.tcl
